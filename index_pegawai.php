              ...
              <div class="card-body mt-2">
                <table class='table table-striped' id="table1">
                  ...
                  <?php 
                    ...
                    $data1 = mysqli_query($koneksi, "SELECT * FROM pegawai order BY nip ASC");
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu dropdown-menu-end">
                            <form method="post" action="pegawai_edit.php">
                              <button class="dropdown-item" type="submit" name="nip" value="<?php echo $row1["nip"];?>"><i class="bi bi-pencil pe-2"></i>Edit</button>
                            </form>
                            <div class="dropdown-divider"></div>
                            <form method="post" action="pegawai_hapus.php">
                              <button class="dropdown-item" type="submit" name="nip" value="<?php echo $row1["nip"];?>"><i class="bi bi-trash pe-2"></i>Hapus</button>
                            </form>
                          </div>
                        </div>
                      </td>
