...
<?php
  ...
  $data1 = mysqli_query($koneksi, "SELECT * FROM pegawai where nip='$nip'");
  $cek1 = mysqli_num_rows($data1);
  if($cek1 > 0){
    while ($row1 = $data1->fetch_assoc()){
      $rfid = $row1["rfid"];
      $nama = $row1["nama"];
      $kelas_jabatan = $row1["kelas_jabatan"];
    }
  }
?>
<head>
    ...
    <div id="app">
      ...
      <div id="main">
        <nav class="navbar navbar-header navbar-expand navbar-light">
          ...
          <h2 class="mt-3">&nbsp&nbsp&nbspData Pegawai</h2>
        ...
        <div class="main-content container-fluid">
            ...
            <div class="col-10 me-4">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-right">
                  <li class="breadcrumb-item"><a href="index_pegawai.php">Data Pegawai</a></li>
          ...
          <div class="page-title ms-5 mt-3">
              <h4 class="">Edit Data Pegawai Dengan NIP : <?php echo $nip;?></h4>
          </div>
            ...
            <div class="col-12 col-md-10">
              <div class="card ms-4 mt-2 me-4">
                <div class="card-body mt-3">
                  <form method="post" class="form form-horizontal" action="pegawai_edit_proses.php">
                    <div class="form-body">
                      <div class="row">
                        ...
                        <div class="col-md-8 form-group pe-md-6">
                          <input type="number" class="form-control" name="nip" placeholder="NIP" value="<?php echo $nip; ?>">
                        </div>
                        <div class="col-md-4 mt-2 ps-md-6 text-dark">
                          <label>RFID</label>
                        </div>
                        <div class="col-md-8 form-group pe-md-6">
                          <input type="text" class="form-control" name="rfid" placeholder="RFID" value="<?php echo $rfid; ?>">
                        </div>
                        <div class="col-md-4 mt-2 ps-md-6 text-dark">
                        ...
                        <div class="col-md-8 form-group pe-md-6">
                          <input type="text" class="form-control" name="kelas_jabatan" placeholder="Kelas Jabatan"value="<?php echo $kelas_jabatan; ?>">
                        </div>
                        <div class="col-sm-12 d-flex justify-content-end pe-md-6 mt-3">
                          <button type="submit" class="btn btn-tema me-1 mb-1">Simpan</button>
                          <a href="index_pegawai.php" class="btn btn-outline-secondary me-1 mb-1">Batal</a>
                        </div>
                      </div>
                    </div>
                  </form>
