...
<?php 
  ...
  $data1 = mysqli_query($koneksi, "SELECT * FROM alat where id_alat='$id_alat'");
  $cek1 = mysqli_num_rows($data1);
  if($cek1 > 0){
    while ($row1 = $data1->fetch_assoc()){
      $ip_alat = $row1["ip_alat"];
      $nama_alat = $row1["nama_alat"];
      $lokasi_alat = $row1["lokasi_alat"];
      $ssid = $row1["ssid"];
    }
  }
?>
      ...
      <div id="main">
        ...
        <div class="main-content container-fluid">
            ...
            <div class="col-10 me-4">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-right">
                  <li class="breadcrumb-item"><a href="index_alat.php">Data Alat</a></li>
          ...
          <div class="page-title ms-5 mt-3">
              <h4 class="">Edit Data Pada ID Alat : <?php echo $id_alat;?></h4>
          </div>
          <section class="section">
            <div class="card ms-4 mt-2 me-4">
              <div class="card-body mt-3">
                <form method="post" class="form form-horizontal" action="alat_edit_proses.php">
                  <div class="form-body">
                    <div class="row">
                      ...
                      <div class="col-md-8 form-group pe-md-6">
                        <input type="number" class="form-control" name="id_alat" placeholder="ID" value="<?php echo $id_alat; ?>">
                      </div>
                      <div class="col-md-4 mt-2 ps-md-6 text-dark">
                        <label>IP Alat</label>
                      </div>
                      <div class="col-md-8 form-group pe-md-6">
                        <input type="text" class="form-control" name="ip_alat" placeholder="IP" value="<?php echo $ip_alat; ?>">
                      </div>
                      <div class="col-md-4 mt-2 ps-md-6 text-dark">
                        <label>Nama Alat</label>
                      </div>
                      <div class="col-md-8 form-group pe-md-6">
                        <input type="text" class="form-control" name="nama_alat" placeholder="Nama" value="<?php echo $nama_alat; ?>">
                      </div>
                      <div class="col-md-4 mt-2 ps-md-6 text-dark">
                        <label>Lokasi Alat</label>
                      </div>
                      <div class="col-md-8 form-group pe-md-6">
                        <input type="text" class="form-control" name="lokasi_alat" placeholder="Lokasi" value="<?php echo $lokasi_alat; ?>">
                      </div>
                      <div class="col-sm-12 d-flex justify-content-end pe-md-6 mt-3">
                        <button type="submit" class="btn btn-tema me-1 mb-1">Simpan</button>
                        <a href="index_alat.php" class="btn btn-outline-secondary me-1 mb-1">Batal</a>
                      </div>
                    </div>
                  </div>
                </form>
